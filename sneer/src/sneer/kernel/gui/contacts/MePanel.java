...
public class MePanel extends JPanel {
	...
	public MePanel( User user, BusinessSource businessSource){
	...
	private JPanel contentPanel(){
		...
		content.add(new LabeledPanel(translate("MSN Login (EMail)"), new ReactiveTextField(_businessSource.output().msnAddress(), _businessSource.msnAddressSetter(), font), font));
