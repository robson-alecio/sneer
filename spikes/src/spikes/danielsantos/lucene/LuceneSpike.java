package spikes.danielsantos.lucene;
...
public class LuceneSpike {

	private static final String INDEX_DIRECTORY_NAME = "tmp";

	public static void main(String[] args) {
		try {
			// Make an writer to create the index
			IndexWriter writer = new IndexWriter(INDEX_DIRECTORY_NAME, new StandardAnalyzer(), true);
