...
public class CopyAndPasteDemo extends JFrame implements ClipboardOwner {
	...
	private void createKeyMaps() {
		...
		textField.getActionMap().put("ctrlc",  new AbstractAction(){@Override public void actionPerformed(ActionEvent e) {
			copy();
		}});

		textField.getInputMap().put(ctrlv,  "ctrlv");
		textField.getActionMap().put("ctrlv",  new AbstractAction(){@Override public void actionPerformed(ActionEvent e) {
			paste();
		}});
	}
