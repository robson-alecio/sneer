 ...
 * 
 * For now, it has been made a RuntimeException because of a bug in the Eclipse compiler . Refactor: Make this a checked Exception again and run all tests once this bug is fixed: https://bugs.eclipse.org/bugs/show_bug.cgi?id=238484 See wheel.lang.Consumer . Eclipse 3.4.0 still has the bug. 
 */
