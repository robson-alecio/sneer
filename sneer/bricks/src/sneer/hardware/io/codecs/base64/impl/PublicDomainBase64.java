package sneer.hardware.io.codecs.base64.impl;
...
/* ********  P U B L I C   F I E L D S  ******** */   
    ...
    final static int NO_OPTIONS = 0;
    
    /** Specify encoding in first bit. Value is one. */
    final static int ENCODE = 1;
    
    
    /** Specify decoding in first bit. Value is zero. */
    final static int DECODE = 0;
    
    
    /** Specify that data should be gzip-compressed in second bit. Value is two. */
    final static int GZIP = 2;
...
/* ********  E N C O D I N G   M E T H O D S  ******** */    
    ...
    static void encode( ByteBuffer raw, ByteBuffer encoded ){
        ...
        while( raw.hasRemaining() ){
            ...
            raw.get(raw3,0,rem);
            PublicDomainBase64.encode3to4(enc4, raw3, rem, PublicDomainBase64.NO_OPTIONS );
            encoded.put(enc4);
        }   // end input remaining
    }
     ...
     * @see PublicDomainBase64#DO_BREAK_LINES
     * @throws java.io.IOException if there is an error
     * @since 2.0
     */
    ...
    throws java.io.IOException {
        ...
        try {
            ...
            b64os = new PublicDomainBase64.OutputStream( baos, ENCODE | options );
    ...
    static byte[] encodeBytesToBytes( byte[] source ) {
        byte[] encoded = null;
        try {
            encoded = encodeBytesToBytes( source, 0, source.length, PublicDomainBase64.NO_OPTIONS );
...
/* ********  D E C O D I N G   M E T H O D S  ******** */
    ...
    static byte[] decode( byte[] source ){
        byte[] decoded = null;
        try {
            decoded = decode( source, 0, source.length, PublicDomainBase64.NO_OPTIONS );
        } catch( IOException ex ) {
            assert false : "IOExceptions only come from GZipping, which is turned off: " + ex.getMessage();
        }
        return decoded;
    ...
    throws java.io.IOException {
        ...
        String encoded = PublicDomainBase64.encodeFromFile( infile );
    ...
    throws java.io.IOException {
        ...
        byte[] decoded = PublicDomainBase64.decodeFromFile( infile );
        java.io.OutputStream out = null;
        try{
            out = new java.io.BufferedOutputStream(
                  new java.io.FileOutputStream( outfile ) );
    ...
    static class InputStream extends java.io.FilterInputStream {
         ...
         *
         * @param input the <tt>java.io.InputStream</tt> from which to read data.
         * @since 1.3
         */
        InputStream( java.io.InputStream input ) {
            this( input, DECODE );
        }   // end constructor
         ...
         * @since 2.0
         */
        InputStream( java.io.InputStream input, int opts ) {
            
            super( input );
            this.options      = opts; // Record for later
    ...
    static class OutputStream extends java.io.FilterOutputStream {
         ...
         *
         * @param output the <tt>java.io.OutputStream</tt> to which data will be written.
         * @since 1.3
         */
        OutputStream( java.io.OutputStream output ) {
            this( output, ENCODE );
        }   // end constructor
         ...
         * @since 1.3
         */
        OutputStream( java.io.OutputStream output, int opts ) {
            super( output );
            this.breakLines   = (opts & DO_BREAK_LINES) > 0;
            this.encode       = (opts & ENCODE) > 0;
            ...
            this.b4           = new byte[4];
            this.options      = opts;
            this.decodabet    = getDecodabet(opts);
        }   // end constructor
            ...
            // Else, Decoding
                ...
                if( decodabet[ theByte & 0x7f ] > WHITE_SPACE_ENC ) {
                    ...
                    if( position >= bufferLength ) { // Enough to output.
                        ...
                        int len = PublicDomainBase64.decode4to3( buffer, 0, b4, 0, options );
                        out.write( b4, 0, len );
                        position = 0;
                    }   // end if: enough to output
