...
public class ThingsTest extends BrickTest {
	...
	private void createApartmentAds() {
		...
		description = "Valor: R$ 66.000,00 Area: 50,00m2 apartamento no Cond. Sta. Efigenia II, 3o andar, 02 quartos, sala, cozinha, Area servico e bwc, piso taco, proximo ao Terminal Barreirinha, com onibus, escola, Posto de Sauºde. Rua Professor Guilherme Butler";
		_subject.create(name, description);
