...
public class ContactListPrinterTest extends TestCase {
	...
	public void testContactListPrinter() throws Exception {
		...
		ContactSource klaus = new ContactSourceImpl("Klaus","klaus.dyndns.org", 42, "", null, 0);
		ContactSource kalecser = new ContactSourceImpl("Kalecser","kalecser.dyndns.org", 42, "", null, 0);
		...
		ContactSource humberto = new ContactSourceImpl("Humba","humba.selfip.org", 8080, "", null, 0);
		sentinel.expect(
		"Off :( - Kalecser - localhost:43," +
