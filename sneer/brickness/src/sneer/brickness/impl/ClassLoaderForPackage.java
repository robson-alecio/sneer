...
class ClassLoaderForPackage extends ClassLoaderWithNatures {	
	...
	public ClassLoaderForPackage(File classRootDirectory, ClassLoader next, List<Nature> natures, String packageName) {
		super(toURLs(classRootDirectory), next, natures);
